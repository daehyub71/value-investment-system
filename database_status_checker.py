...
# -*- coding: utf-8 -*-
"""
전체 데이터베이스 상태 점검 도구 (날짜 파싱 수정 버전)
fixed_date_investigator.py의 올바른 날짜 파싱 로직 적용
...
def main():
    """메인 함수"""
    print("🚀 Finance Data Vibe - 전체 데이터베이스 상태 점검 (날짜 파싱 수정 버전)")
    print("=" * 80)
    ...
    print(f"\n✅ 전체 점검 완료!")
    print(f"💡 날짜 파싱 문제가 해결되었습니다. fixed_date_investigator.py 로직 적용됨")
