...
실행 방법:
python run_technical_analysis_final.py --sample_analysis
python run_technical_analysis_final.py --multiple 005930,000660,035420
"""
...
KOREAN_STOCKS = {
    ...
    '096770': {'name': 'SK이노베이션', 'market': 'KOSPI', 'sector': '석유화학', 'price_range': (80000, 120000)},
    '003550': {'name': 'LG', 'market': 'KOSPI', 'sector': '지주회사', 'price_range': (70000, 100000)},
    '034730': {'name': 'SK', 'market': 'KOSPI', 'sector': '지주회사', 'price_range': (130000, 180000)},
    '015760': {'name': '한국전력', 'market': 'KOSPI', 'sector': '전력', 'price_range': (18000, 25000)},
    ...
    '357780': {'name': '솔브레인', 'market': 'KOSDAQ', 'sector': '반도체소재', 'price_range': (200000, 300000)},
    '121600': {'name': '나노신소재', 'market': 'KOSDAQ', 'sector': '2차전지소재', 'price_range': (100000, 200000)},
    '058470': {'name': '리노공업', 'market': 'KOSDAQ', 'sector': '반도체장비', 'price_range': (150000, 250000)},
    '112040': {'name': '위메이드', 'market': 'KOSDAQ', 'sector': '게임', 'price_range': (40000, 80000)},
    '293490': {'name': '카카오게임즈', 'market': 'KOSDAQ', 'sector': '게임', 'price_range': (20000, 40000)},
}
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='📈 기술분석 실행 스크립트 (최종 안정화 버전)',
...
지원 종목: KOSPI/KOSDAQ 주요 30개 종목
    ...
    print("🚀 기술분석 실행 스크립트 시작 (최종 안정화 버전)")
    print("=" * 60)
    ...
    try:
        ...
        if args.stock_code:
            ...
            # 전체 종목 분석
            stock_codes = list(KOREAN_STOCKS.keys())
            ...
            # KOSPI 상위 10개
            kospi_stocks = [k for k, v in KOREAN_STOCKS.items() if v['market'] == 'KOSPI'][:10]
            print(f"📊 KOSPI 상위 {len(kospi_stocks)}개 분석")
            ...
            # KOSDAQ 상위 10개
            kosdaq_stocks = [k for k, v in KOREAN_STOCKS.items() if v['market'] == 'KOSDAQ'][:10]
            print(f"📊 KOSDAQ 상위 {len(kosdaq_stocks)}개 분석")
